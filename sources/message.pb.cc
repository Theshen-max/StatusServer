...
const ::uint32_t
    TableStruct_message_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::message::GetChatServerRsp, _impl_.uid_),
        4,
        0,
        1,
        2,
...
const char descriptor_table_protodef_message_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "e.GetVarifyRsp\"\0002\211\001\n\rStatusService\022G\n\rGe"
    "tChatServer\022\031.message.GetChatServerReq\032\031"
    ".message.GetChatServerRsp\"\000\022/\n\005Login\022\021.m"
    "essage.LoginReq\032\021.message.LoginRsp\"\000b\006pr"
    "oto3"
};
...
GetChatServerReq::_table_ = {
  {
    ...
    // uint64 uid = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(GetChatServerReq, _impl_.uid_), 0>(),
     {8, 0, 0,
    ...
    // uint64 uid = 1;
    {PROTOBUF_FIELD_OFFSET(GetChatServerReq, _impl_.uid_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
  }},
...
GetChatServerRsp::_table_ = {
  {
    ...
    {::_pbi::TcParser::MiniParse, {}},
    // int32 error = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(GetChatServerRsp, _impl_.error_), 4>(),
     {8, 4, 0,
    ...
    // uint64 uid = 5;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(GetChatServerRsp, _impl_.uid_), 3>(),
     {40, 3, 0,
      PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.uid_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // int32 error = 1;
    {PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.error_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string host = 2;
    ...
    // uint64 uid = 5;
    {PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.uid_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
    "\30\0\4\4\5\0\0\0"
...
// @@protoc_insertion_point(message_clear_start:message.GetChatServerRsp)
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000018U)) {
    ::memset(&_impl_.uid_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.uid_)) + sizeof(_impl_.error_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
void GetChatServerRsp::InternalSwap(GetChatServerRsp* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.error_)
      + sizeof(GetChatServerRsp::_impl_.error_)
      - PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.uid_)>(
...
LoginReq::_table_ = {
  {
    ...
    // string uid = 1;
    {PROTOBUF_FIELD_OFFSET(LoginReq, _impl_.uid_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string token = 2;
    {PROTOBUF_FIELD_OFFSET(LoginReq, _impl_.token_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\20\3\5\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL LoginReq::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_uid().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "message.LoginReq.uid");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
...
LoginRsp::_table_ = {
  {
    ...
    {::_pbi::TcParser::MiniParse, {}},
    // int32 error = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(LoginRsp, _impl_.error_), 2>(),
     {8, 2, 0,
    ...
    // int32 error = 1;
    {PROTOBUF_FIELD_OFFSET(LoginRsp, _impl_.error_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string uid = 2;
    {PROTOBUF_FIELD_OFFSET(LoginRsp, _impl_.uid_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string token = 3;
    {PROTOBUF_FIELD_OFFSET(LoginRsp, _impl_.token_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\20\0\3\5\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL LoginRsp::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_uid().empty()) {
      const ::std::string& _s = this_._internal_uid();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "message.LoginRsp.uid");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
